# Codex Configuration for java-middle

> AI-powered development workspace configuration

## Available Skills

Skills are loaded from `.Codex/skills/` (symlinked from Codex-java).

To use a skill, load it first, then invoke with natural language:

### 1. Git Commit Messages
**Load**: `view .Codex/skills/git-commit/SKILL.md`
...
**Example**:
```
> view .Codex/skills/issue-triage/SKILL.md
> "Triage issues from java-middle, last 15"
...
To configure MCP servers, run from Codex-java:
```bash
...
- [Codex-java](https://github.com/decebals/Codex-java) - Skill repository
- [Codex Docs](https://code.Codex.com/docs) - Official documentation
...
alias cc-commit='echo "view .Codex/skills/git-commit/SKILL.md"'
alias cc-test='echo "view .Codex/skills/test-quality/SKILL.md"'
alias cc-triage='echo "view .Codex/skills/issue-triage/SKILL.md"'
```
